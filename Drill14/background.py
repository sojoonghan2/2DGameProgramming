...
class FixedBackground:
    ...
    def update(self):
        self.window_left = clamp(0, int(server.boy.x) - self.cw // 2, self.image.w - self.cw - 1)
        self.window_bottom = clamp(0, int(server.boy.y) - self.ch // 2, self.image.h - self.ch - 1)
